...
const u32 crcTable[256] = { //Polynomial: 0x1EDC6F41, 0xFFFFFFFF initial value, 0xFFFFFFFF xor, Input Reflection, Output Reflection
...
u32 CalculateCRC32Reflected(u8 *buf, u32 size) {
    ...
    qDebug() << "CRC32: 0x" + QString::number(~crc, 16);
    return ~crc;
}
